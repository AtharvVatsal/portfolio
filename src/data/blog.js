export const blogPosts = [
  {
  id: 1,
  title: "From Pixels to Meaning: How Machines Actually \"See\" Images",
  slug: "from-pixels-to-meaning",
  excerpt: "Three years in computer vision taught me one thing: machines don't see the world, they compress it into patterns. Here's what actually happens between a raw pixel and a prediction.",
  coverImage: "/blog/pixelToMeaning.jpg",
  markdownFile: "/blog/posts/pixelsToMeaning.md",
  category: "AI & ML",
  date: "19-04-2026",
  readTime: "18 min read",
  emoji: "👁️",
  tags: ["Computer Vision", "Deep Learning", "CNN", "Neural Networks", "Machine Learning", "Photography"]
},
  {
    id: 2,
