...
const ResumePage = () => {
  ...
  const skills = {
    ...
    'Architecture & Other': [
      { name: 'OOP & System Design', level: 78 },
      { name: 'API Integration', level: 75 },
      { name: 'DSA', level: 72 },
      { name: 'Secure Data Handling', level: 50 },
    ],
    'Mathematical Foundations': [
      { name: 'Linear Algebra', level: 85 },
      { name: 'Probability & Stats', level: 85 },
  ...
  const projects = [
    {
      name: 'DriveSense',
      subtitle: 'Autonomous Driving Perception — Machine Vision',
      desc: 'Dual-pipeline: YOLOv8n for real-time object detection + U-Net/ResNet34 for semantic segmentation. Trained on BDD100K (100K images) & Cityscapes. Detects vehicles, pedestrians, signs; segments road, sky, vegetation pixel-by-pixel.',
      tech: ['PyTorch', 'YOLOv8n', 'U-Net', 'ResNet34', 'OpenCV', 'CUDA', 'Albumentations'],
    ...
    },
    {
      ...
      desc: 'Predicts crime 24hrs ahead from 7.8M+ records. 100m×100m spatial grid, ensemble ML (XGBoost, RF, LightGBM), 60+ engineered features, DASK distributed processing, Folium heat maps.',
      tech: ['XGBoost', 'LightGBM', 'GeoPandas', 'Dask', 'Folium', 'FastAPI', 'MLflow'],
      color: 'from-cyan-400 to-blue-500',
      gradient: 'from-cyan-500/10 to-blue-500/10',
      link: 'https://github.com/AtharvVatsal/RiskGrid',
    },
    {
      name: 'ProReportStream AI',
      subtitle: 'HP Police Report Automation · 98%+ Accuracy',
      desc: 'Transforms unstructured WhatsApp battalion reports into standardized Excel dashboards. Hybrid regex + DistilBERT NLP. Reduced report prep from 2–3 hours to under 10 seconds.',
      tech: ['DistilBERT', 'NLTK', 'SpaCy', 'LangChain', 'Streamlit', 'XlsxWriter'],
      color: 'from-green-400 to-emerald-500',
      gradient: 'from-green-500/10 to-emerald-500/10',
      link: 'https://github.com/AtharvVatsal/PHQReportStream',
    },
    {
      name: 'HP Police Survey Analysis',
      subtitle: 'Employee Engagement · ML-Driven Insights',
      desc: 'In-depth engagement analysis for HP Police department. ML pattern recognition across districts, survey design, statistical modeling, actionable insights for administration.',
      tech: ['Python', 'R', 'SPSS', 'MySQL', 'Plotly', 'Scikit-learn'],
      color: 'from-blue-400 to-fuchsia-500',
      gradient: 'from-blue-500/10 to-fuchsia-500/10',
    },
    {
      name: 'TheCanspiracy',
      subtitle: 'Real-time Object Detection & Classification',
      desc: 'YOLOv8-based branded can detection across images, video, webcam, and DroidCam. Fine-tuned with source code modifications and data augmentation. Custom Tkinter GUI.',
      tech: ['YOLOv8', 'PyTorch', 'OpenCV', 'Tkinter', 'DroidCam'],
    ...
    },
    {
      ...
      subtitle: 'Full-Stack React + AI Chatbot Integration',
      desc: 'This site — glassmorphism dark theme, custom cursor effects, markdown blog with syntax highlighting, photography gallery with EXIF, Gemini-powered AI assistant, SEO with OG/Twitter Cards/JSON-LD.',
      tech: ['React', 'Tailwind', 'Gemini API', 'EmailJS', 'react-helmet-async'],
      color: 'from-amber-400 to-orange-500',
      gradient: 'from-amber-500/10 to-orange-500/10',
